...
if archivo_csv and archivo_xlsx:
    try:
        ...
        # --- LÓGICA OPCIÓN 2: BASE PARA HUBSPOT ---
            ...
            # Renombrar columnas clave del CSV original de calificaciones de manera compatible
            df_csv.columns = df_csv.columns.str.replace('student', 'student', case=False)
            ...
            if not col_login or 'dni' not in df_base.columns:
                ...
                df_base['dni'] = df_base['dni'].astype(str).str.
